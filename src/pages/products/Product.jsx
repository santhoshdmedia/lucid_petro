...
export const ProductLayout = () => {
  ...
  // Memoize products to prevent unnecessary recalculations
  ...
  const handleSwipe = (direction) => {
    if (direction === "prev") {
      setCurrentSlide((prev) =>
        prev === 0 ? memoizedProducts.length - 1 : prev - 1
      );
    } else {
      setCurrentSlide((prev) =>
        prev === memoizedProducts.length - 1 ? 0 : prev + 1
      );
    }
  };
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <section className="product__section flex flex-col px-4 md:px-10 ">
        ...
        {/* Mobile Slider */}
        <div className="md:hidden relative z-[111] overflow-hidden">
          <div
            className="flex h-[300px] transition-transform duration-300 ease-out"
          ...
          >
            {memoizedProducts.map((product, index) => (
              <div
                key={product.id}
                className="flex-shrink-0 w-full relative h-[300px]"
              >
                ...
                <div className="absolute w-full h-full bg-gradient-to-t from-[#0000000a] to-transparent z-22"></div>
                  <div className="text-white w-full flex flex-col justify-center items-center">
                    ...
                    <p className="mt-2 text-sm drop-shadow-md line-clamp-2">
          ...
          {/* Mobile Navigation */}
          <div className="flex justify-center mt-4 space-x-2 relative z-50">
        ...
        <div className="hidden md:block w-full overflow-hidden">
          <div className="flex h-[500px] mx-auto">
            {memoizedProducts.map((product, index) => (
              <div
                key={product.id}
                className={`relative transition-all duration-300 ease-in-out overflow-hidden ${
                  hoveredIndex === index ? "w-[60%]" : "w-[20%]"
                }`}
              ...
              >
                ...
                />
                <div
                  className={`absolute inset-0 bg-black/25 flex items-end p-8 transition-opacity ${
    ...
    <div className="bg-white">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8 border-b border-gray-200">
          <nav
            className="-mb-px flex space-x-8 flex-wrap"
                ...
                <div className="mt-4 flex gap-3 overflow-x-auto py-2 px-1">
                  {productImages.map((img, index) => (
                    ...
                    >
                      <img
                        src={img}
                        alt={`${currentProductData.productName} - View ${
                          index + 1
                        }`}
                        className="w-full h-full object-cover"
                      />
        ...
        <section className="py-12">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 relative inline-block capitalize">
